...
\note{Il faut replacer tout ca au niveau de la présentation des interruptions}
...
\note{A déplacer dans les interruptions, faire une réference ici}
\begin{lstlisting}
char buf[SIZE]; 
void init() {
  w = r = 0;
