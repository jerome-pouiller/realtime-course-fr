...
\begin{frame}{Systèmes symétriques}
  ...
  \item Pourquoi si tard?
    ...
    \item Algorithme  beaucoup plus  hardu (inversion de  priorité par
      exemple)
    \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}{Limites des système classiques}
  ...
  \begin{itemize}
  \item Politique d'ordonnancement visant à équiliber équitablement le
...
\begin{frame}{Mécanisme basiques}
  \begin{itemize}
  \item  Possibilité  d'éxecuter  une  tache avec  \c{SCHED_RT}  ou
    \c{SCHED_FIFO}
