...
\begin{frame}{Concurence}
  ...
  \begin{center}
    \pgfimage[width=10cm]{pics/concurentVsParallel.png}
  \end{center}
\end{frame}
...
\begin{frame}{Concurence}
  ...
  \begin{center}
    \pgfimage[width=10cm]{pics/model_multitask.png}
  \end{center}
\end{frame} 
...
\begin{frame}{Multitâche non-préemptif}
  ...
  \begin{center}
    \pgfimage[width=7cm]{pics/preemptive-no.png}
  \end{center}
\end{frame}
...
\begin{frame}{Multitâche préemptif}
  ...
  \begin{center}
    \pgfimage[width=10cm]{pics/preemptive-yes.png}
  \end{center}
\end{frame}
...
\begin{frame}{Le changement de contexte sur interruption}
  \begin{center}
    \pgfimage[width=10cm]{pics/interuption-2.png}
  \end{center}
\end{frame} 
